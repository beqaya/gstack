...
[ -z "$P" ] && [ -x "$HOME/.claude/skills/gstack/make-pdf/dist/pdf.exe" ] && P="$HOME/.claude/skills/gstack/make-pdf/dist/pdf.exe"
...
```bash
~/.claude/skills/gstack/bin/gstack-playbook render make-pdf 2>/dev/null || true
```
