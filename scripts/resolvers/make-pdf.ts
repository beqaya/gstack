...
[ -z "$P" ] && [ -x "$HOME${ctx.paths.makePdfDir.replace(/^~/, '')}/pdf.exe" ] && P="$HOME${ctx.paths.makePdfDir.replace(/^~/, '')}/pdf.exe"
[ -z "$P" ] && [ -x "$HOME${ctx.paths.makePdfDir.replace(/^~/, '')}/pdf" ] && P="$HOME${ctx.paths.makePdfDir.replace(/^~/, '')}/pdf"
if [ -x "$P" ]; then
