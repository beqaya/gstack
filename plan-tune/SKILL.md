...
version: 1.0.0
description: |
  Self-tuning question sensitivity + developer psychographic for gstack (v1: observational). Review which AskUserQuestion prompts fire across gstack skills, set per-question preferences
  ...
  or when they explicitly override a recommendation for the Nth time. (gstack)
triggers:
  - tune questions
  - stop asking me that
  - too many questions
