...
export const CARVE_GUARDS: Record<string, CarveGuard> = {
  ship: {
    ...
    maxSkeletonBytes: 71_300, // token-reduction Phases 1-2; measured 70,568 upstream post-merge regen
    minUnionBytes: 170_000, // fork measured union 171,676 after the skill-start absorb (no apple-release / #2700 sections here)
  ...
  'plan-design-review': {
    ...
    maxSkeletonBytes: 72_400, // token-reduction Phases 1-2: preamble bash -> bin/gstack-skill-start, onboarding -> gated emission; fork measured 71,883 (evidence directive + parallel-tools blocks)
  ...
  'office-hours': {
    ...
    minUnionBytes: 114_000, // Phase 4 wave 4; fork measured union 115,031
  ...
  'design-consultation': {
    ...
    maxSkeletonBytes: 52_400, // token-reduction Phases 1-2: preamble bash -> bin/gstack-skill-start, onboarding -> gated emission; fork measured 51,905
