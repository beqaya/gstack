...
function runMetrics(args: string[], cwd: string = repoDir): string {
  ...
  return process.platform === 'win32'
    ? execFileSync('bash', [SCRIPT, ...args], { encoding: 'utf-8', cwd, env: hermeticEnv() })
    : execFileSync(SCRIPT, args, { encoding: 'utf-8', cwd, env: hermeticEnv() });
}
...
describe('gstack-retro-metrics contract', () => {
  ...
  test.skipIf(process.platform === 'win32')('script is executable', () => {
