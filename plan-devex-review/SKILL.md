...
version: 2.0.0
description: |
  Plan review for developer experience - will this be painful to work in day to day. Explores developer personas,
...
```bash
~/.claude/skills/gstack/bin/gstack-playbook render plan-devex-review 2>/dev/null || true
```
