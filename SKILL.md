...
```bash
~/.claude/skills/gstack/bin/gstack-playbook render gstack 2>/dev/null || true
```
...
- User asks to launch a real browser for QA, "open the browser" → invoke `/connect-chrome`
