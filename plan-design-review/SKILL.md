...
interactive: true
version: 2.0.0
description: Plan review for design - how the UI and UX will feel to use. (gstack)
allowed-tools:
  - Read
  - Edit
  - Grep
...
```bash
~/.claude/skills/gstack/bin/gstack-playbook render plan-design-review 2>/dev/null || true
```
