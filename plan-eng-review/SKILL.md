...
interactive: true
version: 1.0.0
description: Plan review for architecture and execution - will this hold up before you build it. (gstack)
...
For reviewing already-written code before landing, use /review instead.
...
```bash
~/.claude/skills/gstack/bin/gstack-playbook render plan-eng-review 2>/dev/null || true
```
