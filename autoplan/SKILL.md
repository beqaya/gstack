...
```bash
~/.claude/skills/gstack/bin/gstack-playbook render autoplan 2>/dev/null || true
```
...
```
If a design doc is found, read it and use it as context for Phase 1 (CEO Review) and the loaded review skills below.
